...
android {
    ...
    compileOptions {
        // flutter_local_notifications 22.x compiles against java.time and requires
        // consumers to enable library desugaring, even when only using immediate
        // (non-scheduled) notifications. See its README "Android Setup".
